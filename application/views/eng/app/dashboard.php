                        ...
                        <form id="email-form"> 
                                    ...
                                    <label class="sr-only" for="inlineFormInputGroupUsername">send</label>
                                        <div class="row justify-content-center" style="height:50px;"> 
                                                <div style="width:400px;background-color:white;display:flex;justify-content:space-around;" class=form-inline >
                                                    ...
                                                    <button style="width:30%;" id="copy-btn" class="btn btn-primary" type="button" onclick="copyFunction()">Copy Link</button>
                                                </div>
                                        </div>
                                      ...
                                      <div class="input-group" style="margin-top: 20px;">
                                        ...
                                        <input type="text"  id="emails" data-role="tagsinput"   placeholder="               send to" >
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center mt-4" style="height: 10%;" id="subsurv">
                                <div class="col-md-7 col-lg-6 col-xl-7" style="text-align: center;">
                                      <input type="submit" class="btn btn-success" id='btn-send' value="Send" style="margin-bottom:10px;font-size: 20px;font-weight: bold;">
                                </div>
                            </div>
                        </form> 
                        <script>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data){
                                            if ( data['empty'] ){
                                                ...
                                                $('#email-messages').text( 'Please enter some emails' );
        ...
        <div class="row " style="height: 100%;">
            <div class="col-md-8 col-lg-8 col-xl-5 mx-auto" style="height: 300px;background-image: url('<?= base_url('assets/img/send.gif');?>'),url('<?= base_url('assets/img/send2.gif');?>');background-repeat: no-repeat;background-size: 10% 50%,10% 50%;background-position:bottom left, bottom right;background-color: white;margin-top:30vh" id="fofo">
                ...
                <div class="row justify-content-center mt-1" id="secinfo" style="height: 10%;">
                    <div class="col-md-12" style="text-align: center;">
                        <h6 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 13px;"> Click to modify  </h6>
                    </div>
                </div>
                ...
                <li style="float: left;">
                    <div class="dropdown " >
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink" style="width: 10px !important" >
                            <a class="dropdown-item" href="<?= site_url('create-survey');?>" style="color: black"><i class="fas fa-plus" style="color: #0079ca"></i> New Survey</a>
                            <a class="dropdown-item" href="<?= site_url('/upgrade');?>" style="color: black"><i class="fas fa-gem" style="color: orange"></i> Upgrade</a>
                            <a class="dropdown-item" href="<?= site_url('/users/settings') ;?>" style="color: black;"><i class="fas fa-cog" style="color: rgb(104,104,104);"></i> Settings</a>
