	...
	<nav class="navbar navbar-light navbar-expand-md"   role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent" >
			...
			<ul id="list" class="navbar-nav ml-auto">
				...
				<li class="nav-item" >
					<a href="<?= site_url()?>" class="nav-link" style="color:black;font-size: 30px;font-weight: bold;" id="home"> Pagina de Inicio </a>
				</li>

				<li class="nav-item" >
					<a href="#" class="nav-link" >
						<button class="btn btn-dark register"  style="font-weight: bold;font-size: 20px" >Registrar</button>  
					</a>
				</li>

				<li id="end_list" class="nav-item">
					<a href="#" class="nav-link" >
						<button class="btn btn-primary login"  style="font-weight: bold;font-size: 20px" >Entrar</button>  
					</a>
				</li>
...
<div class="row justify-content-center" id="main" style="height: 450px;background-image: url('<?=base_url('assets/img/about_wall.jpg')?>');background-size: 100% 100% ">
	<div class="col-md-8 col-xl-5 shadow mt-4 mb-5" style="background-color: white;height: 400px;" id="main_content">
		...
		<div class="row justify-content-center" style="height: 30%;padding-left: 10%;padding-right: 10%">
			<p>
			Online Survey es una plataforma online que permite a
			cualquier negocio evaluar el mercado y visualizar sus resultados. 
			También puedes usar
			nuestro servicio con tus amigos y familia
			</p>
		</div>
	</div>
</div>
...
<div class="row justify-content-center mt-5" style="height: 400px" id="cards">
	<div class=" col-md-5 col-lg-4  col-xl-3 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
				<p>
				Gracias a la red estamos presentes por todas partes y Big
				Brothers dispone de ubicación física en más de 4 países. 
				Nuestro servicio está disponible en 4 lenguas para satisfacer al máximo
				número de personas
				</p>
			</div>
		</div>
	...
	<div class="col-md-5 col-lg-4  col-xl-3 ml-0 ml-md-5 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
			<p>
				La satisfacción del cliente es nuestra prioridad: siempre cumplimos nuestra promesa.				
				Ofrecemos las mejores funcionalidades y una excelente experiencia UI / UX.
			</p>
			</div>
		</div>
	...
	<div class="col-md-5 col-lg-4  col-xl-3 ml-0 ml-md-5 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
				<p>
					Nuestro servicio online es ético y respetuoso del medio ambiente al evitar el uso de
					recuros materiales, hojas de papel y bolígrafos.
				</p>
			</div>
		</div>
