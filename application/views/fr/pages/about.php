			...
			<div class="row justify-content-center mt-1 mb-3" style="height: 26%;font-family: 'Helvetica Neue';margin-bottom:30px !important;">
				<div class="col-md-12" style="text-align: center;">
						<form id="login-form">
							...
							<div class="row justify-content-center mt-2" style="height: 10%;">
								<div class="col-md-8 col-lg-8 col-xl-6" style="text-align: center;">
									<label class="sr-only" for="inlineFormInputGroupPassword">Mot de passe</label>
										<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text"><i class="fas fa-key" style="font-size: 13px"></i></div>
										</div>
										<input type="password" id="login_password" name="login_password" class="form-control" id="inlineFormInputGroupPassword" placeholder="Mot de Passe">
										</div>
								</div>
							</div>
							...
							<div class="row justify-content-center mt-2" style="height: 10%;">
								<div class="col-md-8 col-lg-8 col-xl-6" style="text-align: center;">
									<button type="submit" class="btn btn-primary my-1" style="width: 100%;font-weight: bold;margin-bottom:20px !important;">Se Connecter</button>
								</div>
							</div>
						</form>
						<script>
								...
								$('#login-form').submit(function(e){
									...
									$.ajax({
										...
										error : function(xhr, status, error){
											$('#login-messages').css('display','block');
											$('#login-messages').removeClass('alert-success').addClass('alert-danger');
											$('#login-messages').text('Nous rencontrons un problème !');
											$('#fofo').css('height' , '650px');
											setTimeout(function(){
												$('input').css('border','1px solid #ced4da');
												$('#login-messages').fadeOut('slow');
				...
				<div class="row justify-content-center mt-1" style="height: 15%;width: 100%;">
					<div class="col-md-12" style="text-align: center">
						<h4 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 18px;"> Pas encore de compte ? <span style="color: #0079ca;cursor: pointer;" class="switch_reg">S'enregister</span> </h4>
					</div>
				</div>

				<div class="row justify-content-center mt-1" style="height: 15%;width: 100%;">
					<div class="col-md-12" style="text-align: center">
						<h4 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 16px;"> Mot de passe oublié ? <span style="color: #0079ca;cursor: pointer;" id="switch_recover">Récupérer</span> </h4>
					</div>
				</div>
		...
		<div class="col-md-10 col-lg-8 col-xl-6 mx-auto my-auto" style="height: 550px;background-color: white;min-height: 500px;" id="forgot_div" >
			...
			<div class="row justify-content-center  mb-3" style="height: 20%;font-family: 'Helvetica Neue';">
						...
						<div class="row justify-content-center mt-2" style="height: 10%;">
							<div class="col-md-5" style="text-align: center;">
								...
								<button disabled class="btn btn-primary my-1" id="btn-loader" style="display:none;width: 100%;font-weight: bold;">
									<i class="fa fa-circle-o-notch fa-spin"></i> Envoi en cours..
								</button>
							</div>
						</div>
					</form>
						...
						$('#reset-password-form').submit(function(e){
							...
							$.ajax({
								...
								error : function(xhr, status, error){
									...
									$('#reset-password-messages').css('display','block');
									$('#reset-password-messages').removeClass('alert-success').addClass('alert-danger');
									$('#reset-password-messages').text('Nous rencontrons un problème !');
									$('#btn-recover').css('display' , 'block');
									$('#btn-loader').css('display' , 'none');
									$('#btn-recover').prop('disabled' , false);
									$('#forgot_div').css('height' , '650px');
				...
				<div class="row justify-content-center mt-4" style="height: 5%;width: 100%;">
					<div class="col-md-12" style="text-align: center">
						<h4 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 17px;"> Pas encore de compte ? <span style="color: #0079ca;cursor: pointer;" class="switch_reg">S'enregistrer</span> </h4>
					</div>
				</div>
		...
		<div class="col-md-10 col-lg-8 col-xl-6 mx-auto my-auto" style="height: 620px;background-color: white;" id="register_div">
			...
			<div class="row justify-content-center mt-1 mb-3" style="height: 30%;font-family: 'Helvetica Neue';">
				<div class="col-10 col-md-12" style="text-align: center;">
						...
						<form id="register-form">
							...
							<div class="row  justify-content-center mt-0" style="height: 10%;">
								<div class="col-md-5 " style="text-align: center;">
									<label class="sr-only" for="RegisterInputGroupUsername">Nom d'utilisateur</label>
										<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text"><i class="fas fa-user" style="font-size: 13px"></i></div>
										</div>
										<input type="text" id="register_name" name="register_name" class="form-control" id="RegisterInputGroupUsername" placeholder="Nom d'utilisateur">
										</div>
								</div>
							</div>
							...
							<div class="row justify-content-center mt-2" style="height: 10%;">
								<div class="col-md-5" style="text-align: center;">
									<label class="sr-only" for="RegisterInputGroupPassword">Mot de Passe</label>
										<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text"><i class="fas fa-key" style="font-size: 13px"></i></div>
										</div>
										<input type="password" id="register_password" name="register_password" class="form-control" id="RegisterInputGroupPassword" placeholder="Mot de Passe">
										</div>
								</div>
							</div>
							<div class="row justify-content-center mt-2" style="height: 10%">
								<div class="col-md-5" style="text-align: center;">
									<label class="sr-only" for="RegisterInputGroupConfPassword">Confirmation de Mot de Passe</label>
										<div class="input-group">
										<div class="input-group-prepend">
											<div class="input-group-text"><i class="fas fa-key" style="font-size: 13px"></i></div>
										</div>
										<input type="password" id="register_password_confirm" name="register_password_confirm" class="form-control" id="RegisterInputGroupConfPassword" placeholder="Confirmation de Mot de Passe">
										</div>
								</div>
							</div>
							<div class="form-check">
								<input type="checkbox" class="form-check-input" id="auto-login" name="auto-login" checked>
								<label class="form-check-label" for="exampleCheck1">Se connecter Automatiquement</label>
							</div>

							<div class="row justify-content-center mt-2" style="height: 10%">
								<div class="col-md-5" style="text-align: center;">
									<button type="submit"  class="btn btn-primary my-1" style="width: 100%;font-weight: bold;">S'enregister</button>
								</div>
							</div>
						</form>
									...
									success: function(data){ 
										if ( data['error'] == true ){
											...
											if ( 'register_success' in data ){
												...
												$('#register-messages').removeClass('alert-success').addClass('alert-danger');
												$('#register-messages').text(data['register_failed']);
												$('#register_div').css('height','750px');
											}
											setTimeout(function(){
												$('input').css('border','1px solid #ced4da');
				...
				<div class="row justify-content-center mt-1" style="height: 5%;width: 100%;">
					<div class="col-md-12" style="text-align: center">
						<h4 id="secure" style="margin:auto;color: rgb();color: rgb(195,199,202);font-size: 17px;"> Déjà Membre ? <span style="color: #0079ca;cursor: pointer;font-weight: bold;" id="switch_log">Se Connecter</span> </h4>
					</div>
				</div>
...
<div class="container-fluid" style="background-color: black;position: absolute;width: 100%;height: 100%;background-color: rgba(50,50,50,0.8);z-index: 3;position: fixed;display: none;" id="register_form">
	<div class="row " style="height: 100%;">
		<div class="col-md-10 col-lg-8 col-xl-6 mx-auto my-auto" style="height: 620px;background-color: white;" >
			<div class="row justify-content-end " style="height: 17%;font-family: 'Helvetica Neue';">
			...
			<div class="row justify-content-center" style="height: 110px;z-index: 0" id="img_regi" >
				<div class="col-md-12 " style="text-align: center;height: 100%" >
					<img src="<?= base_url('assets/img/team_register.jpg');?>" style="height: 100%;width: 60%;max-width: 500px">
				</div>
			</div>
			...
			<div class="row justify-content-center mt-1 mb-3" style="height: 30%;font-family: 'Helvetica Neue';">
				<div class="col-10 col-md-12" style="text-align: center;">
						...
						<form id="register-form">
							...
							<div class="row justify-content-center mt-2" style="height: 10%">
								<div class="col-md-5" style="text-align: center;">
									<button type="submit"  class="btn btn-primary my-1" style="width: 100%;font-weight: bold;">S'enregistrer</button>
								</div>
							</div>
						</form>
							...
							$('#register-form').submit(function(e){
								...
								$.ajax({
									...
									error : function(xhr, status, error){
										$('#register-messages').css('display','block');
										$('#register-messages').removeClass('alert-success').addClass('alert-danger');
										$('#register-messages').text('Nous avons rencontré un probleme');
										setTimeout(function(){
											$('input').css('border','1px solid #ced4da');
											$('#register-messages').fadeOut('slow');
										},5000);
		...
		<div id="burger_content" class="mr-auto" style="height: 100%;width:100%;border-bottom-left-radius: 50%;float: right;display:none">
			...
			<div style="width: 100%;height: 300px;">
				<ul id="list" class="navbar-nav ml-auto"> 
					...
					<li class="nav-item" > 
						<div class="dropdown">
							<a id="lang" class="nav-link dropdown-toggle text-dark" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black;font-size: 25px"> 
								<img src="<?= base_url('assets/img/Fr.svg');?>" style="height: 20px;width: 20px;"> Français
							</a> 
					...
					<li  class="nav-item" > 
						<a href="#" class="nav-link" style="color: black;text-align: center;font-weight: bold;font-size: 25px;"> 
							<button class="btn btn-success login" style="font-weight: bold;font-size: 25px;width: 90%" >Se Connecter</button> 
						</a> 
					</li> 
					<li class="nav-item"> 
						<a href="#" class="nav-link" style="text-align: center;font-weight: bold;font-size: 25px;"> 
							<button class="btn btn-dark register" style="font-weight: bold;font-size: 25px;width: 90%">S'enregistrer</button> 
						</a> 
					</li> 
					<li class="nav-item"> 
						<a href="<?= site_url('create-survey')?>" class="nav-link" style="color: black;text-align: center;font-weight: bold;font-size: 25px;"> 
							<button class="btn btn-primary" style="font-weight: bold;font-size: 25px;width: 90%" >Lancez Vous</button> 
						</a> 
					</li> 
				</ul>
			</div>
	...
	<nav class="navbar navbar-light navbar-expand-md"   role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent" >
			...
			<ul id="list" class="navbar-nav ml-auto">
				...
				<li class="nav-item" >
					<div class="dropdown">
						<a id="lang" class="nav-link dropdown-toggle text-dark" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
							<img src="<?= base_url('assets/img/Fr.svg');?>" style="height: 20px;width: 20px;font-family: 'Helvetica'"> Français
						</a>
				...
				<li class="nav-item" >
					<a href="<?= site_url()?>" class="nav-link" style="color:black;font-size: 30px;font-weight: bold;" id="home"> Accueil </a>
				</li>

				<li class="nav-item" >
					<a href="#" class="nav-link" >
						<button class="btn btn-dark register"  style="font-weight: bold;font-size: 20px" >S'enregistrer</button>  
					</a>
				</li>

				<li id="end_list" class="nav-item">
					<a href="#" class="nav-link" >
						<button class="btn btn-primary login"  style="font-weight: bold;font-size: 20px" >Se Connecter</button>  
					</a>
				</li>
...
<div class="row justify-content-center" id="main" style="height: 450px;background-image: url('<?=base_url('assets/img/about_wall.jpg')?>');background-size: 100% 100% ">
	<div class="col-md-8 col-xl-5 shadow mt-4 mb-5" style="background-color: white;height: 400px;" id="main_content">
		...
		<div class="row justify-content-center" style="height: 30%;padding-left: 10%;padding-right: 10%">
			<p>
				Online Survey est une plateforme en ligne qui permets a n'importe quel business d'évaluer leur marché et de visualiser leur résultats. 
				C'est une solution simple , puissante et bien pensée pour n'importe qui qui  veut en savoir plus sur ces clients ou employées.
				Vous pouvez meme utilisé notre solution avec vos amis et votre famille
			</p>
		</div>
	</div>
</div>

<div class="row justify-content-center mt-5" style="height: 400px" id="cards">
	<div class=" col-md-5 col-lg-4  col-xl-3 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
				<p>
				Grace au monde d'internet nous sommes présent partout, et Big Brothers est présente physiquement dans plus de 4 pays.
				Notre solution est disponible dans 4 langues différentes pour etre capable de satisfaire le maximum de personnes
				</p>
			</div>
		</div>
	...
	<div class="col-md-5 col-lg-4  col-xl-3 ml-0 ml-md-5 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
				<p>
				Nous croyons en la satisfaction du client c'est pour cela que nous gardons toujours notre promesse
				Nous offrons les meilleures fonctionnalitées et une excellente expérience UI / UX
				</p>
			</div>
		</div>
	...
	<div class="col-md-5 col-lg-4  col-xl-3 ml-0 ml-md-5 shadow" style="background-color: white;max-height: 400px;max-width: 500px">
		...
		<div class="row mt-4 justify-content-center" style="height: 40%">
			<div class="col-md-9 mt-4" style="text-align: center;">
				<p>
				A travers notre produit, nous agissons de manière positive envers l'environnement puisque nous voulons que le maximum de business d'effectuer des sondages en ligne au lieu d'utiliser du papier et stylo 
				</p>
			</div>
		</div>
...
<div class="container-fluid" >
	<div class="row justify-content-center mt-5" id="team" style="height: 400px;background-color: rgb(241,246,247);">
		<div class="col-md-4" >
			<div class="row justify-content-center" style="height: 50%;margin-top: 30px">
				<div style="height: 200px;background-color: red;width: 200px;border-radius: 50%;overflow: hidden;">
					<img src="<?=base_url('assets/img/l.png')?>" style="height: 100%;width: 100%;object-fit: cover;">
				</div>
			</div>
			<div class="row justify-content-center mt-1" style="height: 10%">
				<h3>Reda LEGZALI</h3>
			</div>
			<div class="row justify-content-center mt-1" style="height: 7%">
				<h6 style="color: rgb(100,100,100);" alt="Profile Photo Chief Developer"> Chef Développeur </h6>
			</div>
			<div class="row justify-content-center mt-3" style="height: 7%">
				<a href="https://www.linkedin.com/in/mohamed-reda-legzali-055467174/">
					<i class="fab fa-linkedin" style="font-size: 30px;color: #0072b1;cursor: pointer"></i>
				</a>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="row justify-content-center" style="height: 50%;margin-top: 30px">
				<div style="height: 200px;background-color: red;width: 200px;border-radius: 50%;overflow: hidden;">
					<img src="<?=base_url('assets/img/s.jpg')?>" style="height: 100%;width: 100%;object-fit: cover;">
				</div>
			</div>
			<div class="row justify-content-center mt-1" style="height: 10%">
				<h3>Samy SIMON</h3>
			...
			<div class="row justify-content-center mt-1" style="height: 7%">
				<h6 style="color: rgb(100,100,100);" alt="Profile Photo Project Manager"> Chef de Projet </h6>
			</div>
			<div class="row justify-content-center mt-3" style="height: 7%">
				<a href="https://www.linkedin.com/in/samy-simon-779103175/">
					<i class="fab fa-linkedin" style="font-size: 30px;color: #0072b1;cursor: pointer"></i>
				</a>
			</div>
		...
		<div class="col-md-4">
			<div class="row justify-content-center" style="height: 50%;margin-top: 30px">
				<div style="height: 200px;background-color: red;width: 200px;border-radius: 50%;overflow: hidden;">
					<img src="<?=base_url('assets/img/n2.png')?>" style="height: 100%;width: 100%;object-fit: cover;" alt="Profile Photo Marketing Director">
				</div>
			</div>
			<div class="row justify-content-center mt-1" style="height: 10%">
				<h3>Neeraj NANWANI</h3>
			</div>
			<div class="row justify-content-center mt-1" style="height: 7%">
				<h6 style="color: rgb(100,100,100);"> Directeur Marketing </h6>
			</div>
			<div class="row justify-content-center mt-3" style="height: 7%">
				<a href="https://www.linkedin.com/in/neeraj-nanwani-2a9789189/">
					<i class="fab fa-linkedin" style="font-size: 30px;color: #0072b1;cursor: pointer"></i>
				</a>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="mb-5 flex-center" style="color: white">
			...
			<a href="<?=site_url('contact');?>">
				<button class="btn btn-info" style="float:right;font-weight:bold" >Contactez Nous </button>
			</a>
