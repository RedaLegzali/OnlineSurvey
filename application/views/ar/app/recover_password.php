            ...
            <?=  form_open( 'users/reset_password_confirm/'.$token ); ?>
                ...
                <div class="row justify-content-center mt-3" style="height: 40px;">
                    <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" name="email" type="email" class="form-control" placeholder="البريد الإلكتروني">
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-3" style="height: 40px;">
                    <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;">
                        ...
                        <div class="input-group">
                            ...
                            <input id="password_confirm" name="password_confirm" type="password" class="form-control" placeholder="تأكيد كلمة السر">
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-3" style="height: 40px;">
                    <div class="col-md-8 col-lg-8 col-xl-6  " style="text-align: center;max-width: 500px;min-width: 350px;min-width: 350px;">
                        <button type="submit" class="btn btn-primary my-1" style="width: 100%;font-weight: bold;"> استعادة </button>
                    </div>
                </div>
            <?= form_close(); ?>
